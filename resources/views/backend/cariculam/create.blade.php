    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <hr><hr>
                <form method="POST" action="{{ route('cariculam.store') }}" class="new-added-form">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-12 form-group">
                            ...
                            <input id="name" type="text" name="name" class="form-control @error('name') is-invalid @enderror"  value="{{ old('name') }}"placeholder="Ex. Diplomar in Engineering" autofocus  autocomplete="name" >
                        </div>
                        <div class="col-xl-4  col-lg-4 col-12 form-group">
